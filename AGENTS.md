...
- **Keep docs in sync.** Feature and architectural changes must update `README.md`.

## Project Sources of Truth
The primary sources of truth for project rules, architecture, and workflow are maintained in the `conductor/` directory:
