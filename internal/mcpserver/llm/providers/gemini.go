...
func NewGemini(opts GeminiOptions) *GeminiProvider {
	...
	return &GeminiProvider{
		...
		log:        opts.Logger.With().Str("provider", "gemini").Logger(),
	}
}
...
func (p *GeminiProvider) Embed(
	...
	return EmbedResult{}, errors.New("gemini provider currently does not support embeddings")
}
...
func newGeminiHTTPStatusError(resp *http.Response) error {
	...
	if resp.StatusCode == http.StatusTooManyRequests {
		return &RateLimitError{Message: trimmed}
	}
