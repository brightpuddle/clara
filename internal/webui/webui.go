...
func (w *WebUI) Mount(mux *http.ServeMux) {
	...
	e.GET("/ui/triggers/new", w.handleTriggerNew)
	e.POST("/ui/triggers", w.handleTriggerCreate)
	e.GET("/ui/triggers/:id", w.handleTriggerDetail)
	e.GET("/ui/triggers/:id/edit", w.handleTriggerEdit)
	e.POST("/ui/triggers/:id", w.handleTriggerUpdate)
	e.POST("/ui/triggers/:id/run", w.handleTriggerRun)
	e.POST("/ui/triggers/:id/delete", w.handleTriggerDelete)
	e.DELETE("/ui/triggers/:id", w.handleTriggerDelete)
